...
export default function StaffScreensPage() {
                  ...
                  <tr key={screen.id}>
                    ...
                    <td>
                      <div className="admin-actions" style={{ flexDirection: 'row', gap: '8px' }}>
                        <button className="admin-action-btn" onClick={() => openEditModal(screen)} title="Sửa">✏️</button>
                        <button className="admin-action-btn" onClick={() => handleRegenerateSeats(screen)} title="Tạo lại ghế">🪑</button>
                        <button className="admin-action-btn admin-action-btn--danger" onClick={() => handleDelete(screen)} title="Xóa" disabled={screen.showtimeCount > 0}>🗑️</button>
                      </div>
                    </td>
                  </tr>
                ))
