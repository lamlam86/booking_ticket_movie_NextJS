                  ...
                  <tr key={showtime.id}>
                    ...
                    <td>
                      <div className="admin-actions" style={{flexDirection: 'row', gap: '8px'}}>
                        <button className="admin-action-btn" onClick={() => openEditModal(showtime)} title="Sửa">✏️</button>
                        <button className="admin-action-btn admin-action-btn--danger" onClick={() => handleDelete(showtime)} title="Xóa" disabled={showtime.bookings_count > 0}>🗑️</button>
                      </div>
                    </td>
                  </tr>
                ))
